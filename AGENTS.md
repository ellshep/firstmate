...
config/calm     Calm presentation preference shared by the Pi extension, the Claude Code mod, and the Claude Code marker filter; LOCAL, gitignored, and not inherited; see docs/configuration.md "Calm preference"
