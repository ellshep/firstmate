...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-contract.test.sh 16047
tests/fm-afk-inject-e2e.test.sh 35792
tests/fm-afk-pi-herdr-return-e2e.test.sh 100
tests/fm-afk-return.test.sh 20323
tests/fm-agy-harness.test.sh 47463
...
tests/fm-backend-orca.test.sh 22784
tests/fm-backend-tmux-smoke.test.sh 393
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 9418
tests/fm-backend.test.sh 21308
tests/fm-backlog-atomicity.test.sh 173184
tests/fm-backlog-handoff.test.sh 54032
tests/fm-backlog-read-bound.test.sh 24295
tests/fm-bearings-board-lavish-live-e2e.test.sh 51
tests/fm-bearings-board-render.test.sh 12699
tests/fm-bearings-board.test.sh 36588
tests/fm-bearings-snapshot.test.sh 169402
tests/fm-bootstrap-network-parallel.test.sh 9749
tests/fm-bootstrap.test.sh 106701
tests/fm-branch-supervision.test.sh 9226
tests/fm-busy-adapter-wiring.test.sh 49731
tests/fm-busy-state.test.sh 2964
tests/fm-calm-claude-mod-live-e2e.test.sh 45
tests/fm-calm-claude-mod-plugin.test.sh 209
tests/fm-calm-claude-mod.test.sh 1267
tests/fm-calm-pi-extension.test.sh 56849
tests/fm-check-unregister.test.sh 481
tests/fm-ci-workflow.test.sh 2073
tests/fm-classify-corr-token.test.sh 53855
tests/fm-classify-decision-key.test.sh 3317
tests/fm-claude-stop-autoarm-live-e2e.test.sh 74
tests/fm-claude-stop-autoarm.test.sh 61068
tests/fm-claude-trust.test.sh 10789
tests/fm-cmux-claude-composer-live-e2e.test.sh 50
tests/fm-codex-continuity-live-e2e.test.sh 44
tests/fm-codex-hook-layer-live-e2e.test.sh 45
tests/fm-composer-codex-idle-live-e2e.test.sh 160
tests/fm-composer-matrix-live-e2e.test.sh 80
tests/fm-contributions.test.sh 35673
tests/fm-control-relaunch.test.sh 141379
tests/fm-control.test.sh 54301
tests/fm-cursor-harness.test.sh 30251
tests/fm-cursor-primary-live-e2e.test.sh 48
tests/fm-cursor-primary.test.sh 54947
tests/fm-daemon.test.sh 28928
tests/fm-dispatch-resolve.test.sh 4656
tests/fm-documentation-audiences.test.sh 844
...
tests/fm-harness-adapter-instructions-live-e2e.test.sh 80
tests/fm-harness-adapter-references.test.sh 59
tests/fm-harness-liveness-drift-live-e2e.test.sh 978
tests/fm-harness-precedence.test.sh 3948
tests/fm-herdr-attached-viewer-live-e2e.test.sh 19000
tests/fm-herdr-pi-stale-registration-live-e2e.test.sh 46
...
tests/fm-opencode-primary-live-e2e.test.sh 74
tests/fm-operational-input.test.sh 232
tests/fm-peek-remote.test.sh 1018
tests/fm-pending-reply.test.sh 86711
tests/fm-pi-branch-extension.test.sh 60240
tests/fm-pi-branch-live-e2e.test.sh 70
tests/fm-pi-branch-responsiveness-live-e2e.test.sh 12973
tests/fm-pi-codex-native.test.sh 46
tests/fm-pi-primary-live-e2e.test.sh 76
tests/fm-pi-watch-extension.test.sh 51157
tests/fm-pi-windows-shell-invocation.test.sh 5121
tests/fm-pr-check-security.test.sh 239099
tests/fm-pr-reviewers.test.sh 350
tests/fm-pr-state-live-e2e.test.sh 58
tests/fm-pr-state.test.sh 684
tests/fm-procevent-quota.test.sh 1949
tests/fm-procevent-when.test.sh 23374
tests/fm-procevent.test.sh 219640
tests/fm-project-origin.test.sh 214
tests/fm-public-followup.test.sh 196745
tests/fm-quota-array-dispatch-live-e2e.test.sh 49
tests/fm-quota-choose.test.sh 1475
tests/fm-remote-backlog-handoff.test.sh 81897
tests/fm-remote-doctor.test.sh 13626
tests/fm-remote-entrypoint.test.sh 132
tests/fm-remote-herdr-guard.test.sh 3102
tests/fm-remote-job-orphan-reap.test.sh 2972
tests/fm-remote-job.test.sh 59603
tests/fm-remote-reply.test.sh 121599
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 237381
tests/fm-remote-secondmate-parent-binding.test.sh 32629
tests/fm-remote-secondmate-trace-context.test.sh 67096
tests/fm-remote-transport-lanes.test.sh 63976
tests/fm-rovo-harness.test.sh 14806
tests/fm-rovo-signals-live-e2e.test.sh 48
tests/fm-secondmate-harness.test.sh 169783
tests/fm-secondmate-lifecycle-e2e.test.sh 9713
tests/fm-secondmate-liveness.test.sh 18747
tests/fm-secondmate-reconcile.test.sh 98340
tests/fm-secondmate-restart.test.sh 119085
tests/fm-secondmate-safety.test.sh 120636
tests/fm-secondmate-sync.test.sh 85277
tests/fm-send-agy-confirm.test.sh 9710
tests/fm-send-inbox-doorbell-live-e2e.test.sh 49
tests/fm-send-inbox.test.sh 38956
tests/fm-send-remote-delivery.test.sh 29082
tests/fm-send-resolve-key.test.sh 30124
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 76
tests/fm-send-secondmate-marker.test.sh 6252
tests/fm-session-lock-ancestry.test.sh 2767
tests/fm-session-start.test.sh 156952
tests/fm-sessionstart-hook-live-e2e.test.sh 70
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 79
tests/fm-sessionstart-nudge.test.sh 67341
tests/fm-shared-captain-inheritance.test.sh 6108
tests/fm-spawn-dispatch-profile.test.sh 138658
tests/fm-spawn-pool-base-freshen.test.sh 62051
tests/fm-spawn-worktree-settle.test.sh 8776
tests/fm-startup-memory-budget.test.sh 7430
...
tests/fm-task-delivery.test.sh 21029
tests/fm-task-inbox.test.sh 30205
tests/fm-tasks-axi.test.sh 2105
tests/fm-teardown-endpoint-safety.test.sh 35287
tests/fm-teardown.test.sh 144133
tests/fm-test-fixture-cleanup.test.sh 915
tests/fm-test-fixtures.test.sh 2125
tests/fm-test-isolation-proof.test.sh 2852
tests/fm-tmux-agent-liveness.test.sh 2119
tests/fm-tool-update-check.test.sh 14176
tests/fm-trace-context-lib.test.sh 209
tests/fm-trace-context-spawn.test.sh 49616
tests/fm-turnend-guard.test.sh 42565
tests/fm-update.test.sh 11824
tests/fm-vendor-auth-probe.test.sh 45586
tests/fm-voice-relay.test.sh 33774
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7904
tests/fm-wake-drain-open-decisions-cursor.test.sh 40728
tests/fm-wake-drain-open-decisions.test.sh 7234
tests/fm-wake-drain-outcome-backstop.test.sh 44802
tests/fm-wake-drain-unread-status.test.sh 35078
tests/fm-wake-queue.test.sh 84791
tests/fm-watch-arm.test.sh 69539
tests/fm-watch-checkpoint.test.sh 5972
tests/fm-watch-recovery-loop.test.sh 59058
tests/fm-watch-triage.test.sh 698475
