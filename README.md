...
Claude Code also carries a separate marker filter that hides only the narration lines Firstmate explicitly marks, needs no such flag, and is the presentation active by default.
