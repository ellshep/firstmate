...
The same stored choice also lets Claude Code drop Firstmate's explicitly marked mid-turn narration from the screen, while every unmarked line still prints and the transcript, model context, and exports stay complete.
