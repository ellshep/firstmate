...
test_matrix_herdr_halfblock_rule_bounds_bare_wrap() {
  ...
  # Glyphs are written literally, never as `\uXXXX`: bash only learned that
  # escape in 4.2, so under bash 3.2 the fixture degrades into its own ASCII
  # escape text and the case fails against a correct classifier.
  local screen plain out
